...
export interface ApiDiplomaDiploma extends Schema.CollectionType {
  ...
  attributes: {
    ...
    maxGpa: Attribute.Integer;
    overallGpa: Attribute.Decimal;
...
export interface ApiJobJob extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['freelance', 'professional']>;
    start: Attribute.Date;
    end: Attribute.Date;
    description: Attribute.Blocks;
...
export interface ApiSkillSkill extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tags: Attribute.Relation<'api::skill.skill', 'oneToMany', 'api::tag.tag'>;
