...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Singleton About Me page';
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A blog post with rich content and media';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['general', 'technology', 'project', 'design', 'career', 'personal']
    > &
      Schema.Attribute.Required &
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An individual course linked to an education entry';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiEducationEducation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Academic education entry';
  ...
  attributes: {
    ...
    gradeScale: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::education.education'
...
export interface ApiResumeResume extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Downloadable resume versions';
    displayName: 'Resume';
    pluralName: 'resumes';
    singularName: 'resume';
  };
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A skill or technology that can be referenced across jobs, projects, and more';
    displayName: 'Skill';
    pluralName: 'skills';
    singularName: 'skill';
  };
...
export interface ApiSocialLinkSocialLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['personal', 'professional']> &
      Schema.Attribute.Required &
